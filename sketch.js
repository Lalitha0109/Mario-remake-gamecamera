...
function setup() {
  ...
  ground = createSprite(300,350,3500,10);
...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("Score: "+ score,camera.position.x+280,camera.position.y-170);
  text("life:"+life,camera.position.x+280,camera.position.y-140);
...
function spawnCoin() {
  ...
  if (frameCount % 60 === 0) {
    ...
    coin.x = random(camera.position.x-50,camera.position.y-200);
...
function spawnObstacles() {
  if (frameCount % 60 === 0) {
    ...
    obstacle.x=random(camera.position.x+200,camera.position.x-200);
